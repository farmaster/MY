...
[task_local]
#东东工厂
10 */3 * * * jd_jdfactory.js, tag=东东工厂, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_factory.png, enabled=true
...
//console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `http://transfer.nz.lu/ddfactory`, timeout: 1}, (err, resp, data) => {
      try {
        if (err) {
       // console.log(JSON.stringify(err))
   //  console.log(`助力池网址获取错误！`)
        } else {
          if (data) {
