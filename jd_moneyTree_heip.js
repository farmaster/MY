...
function requireConfig() {
 ...
 function shareCodesFormat() {
  return new Promise(async resolve => {
    $.newShareCodes = [];
    let inviteCodes = [
      '5UHtABZXiJcIJuAJuZ0l5sAdoUJQ3Dik@8pBboeweSJBW7DJ_CwpYsw@cm8nOUTgHH0QaHTAV67vhuQ@Mxrg_FwP3vUi1CHbXSeB6g',
      '5UHtABZXiJcIJuAJuZ0l5sAdoUJQ3Dik@8pBboeweSJBW7DJ_CwpYsw@m8nOUTgHH0QaHTAV67vhuQ@Mxrg_FwP3vUi1CHbXSeB6g'
    ];
    if ($.shareCodesArr[$.index - 1]) {
      $.newShareCodes = $.shareCodesArr[$.index - 1].split('@');
    } else {
      console.log(`由于您第${$.index}个京东账号未提供shareCode,将为本脚本作者【py】助力\n`)
